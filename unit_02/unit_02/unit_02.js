...
const f1 = () => {
    let in1 = +document.querySelector('.i-1').value; // обратите внимание в массиве только ЧИСЛА!
    document.querySelector('.out-1').textContent = a1.includes(in1);
    //
}
...
const f2 = () => {
    ...
    document.querySelector('.out-2').textContent = a2.includes(in2) + ' ' + a2.indexOf(in2);
