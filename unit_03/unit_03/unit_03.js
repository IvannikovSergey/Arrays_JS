...
const f3 = () => {
    let in3 = document.querySelector('.i-3').value; // ваш код
    console.log(a3.push(in3)); // console.log(a3.push(ваша переменная));
    console.log(a3); // console.log(a3);
}
...
const f5 = () => {
    let in5 = +document.querySelector('.i-5').value;
    a5[a5.length] = in5;
    console.log(a5);
}
